...
// FinalizerLoadBalancerCertificateBundle guards LoadBalancerCertificateBundle
// deletion.
const FinalizerLoadBalancerCertificateBundle = "loadbalancer.upcloud.polarsquad.com/loadbalancercertificatebundle"

// +kubebuilder:rbac:groups=loadbalancer.upcloud.polarsquad.com,resources=loadbalancercertificatebundles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.upcloud.polarsquad.com,resources=loadbalancercertificatebundles/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=loadbalancer.upcloud.polarsquad.com,resources=loadbalancercertificatebundles/finalizers,verbs=update
